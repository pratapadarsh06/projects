...
void startGame(){
    ...
    //Road Left Border
    glColor3f(0.412, 0.412, 0.412); //gray
    glBegin(GL_POLYGON);
    glVertex2f(20,0);
    glVertex2f(20,100);
    glVertex2f(23,100);
    ...
    //KIll check car1
    if((abs(lrIndex-lrIndex1)<8) && (car1+100<10)){             //smjhna
            start = 0;
            gv=1;
    ...
    //KIll check car2
    if((abs(lrIndex-lrIndex2)<8) && (car2+100<10)){     //smjhna
            start = 0;
            gv=1;
    }
...
void fristDesign(){
        ...
        if(gv==1){
            ...
            renderBitmapString(35,60+10,GLUT_BITMAP_TIMES_ROMAN_24,"GAME OVER");
        ...
        renderBitmapString(30,85,GLUT_BITMAP_TIMES_ROMAN_24,"Road Horizon ");
        glColor3f(0.000, 1.000, 0.000);
        renderBitmapString(30,50+10,GLUT_BITMAP_HELVETICA_18,"Press SPACE to START");
        ...
        renderBitmapString(30,50-8+10,GLUT_BITMAP_8_BY_13,"Press DWON to decrease Speed");
        ...
        renderBitmapString(20,50-40,GLUT_BITMAP_8_BY_13,"Project By:");
        renderBitmapString(20,50-43,GLUT_BITMAP_8_BY_13,"ADARSH THAKUR AND   PARAS NARAYAN GAUTAM");
